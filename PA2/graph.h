...
struct graph {
  ...
  // The node that reaches vertex i's by incoming edge is given by
  // incoming_edges[incoming_starts[i]].  To iterate over all
  // incoming_edges, please see the bottom-up bfs implementation.
  int *incoming_starts;
